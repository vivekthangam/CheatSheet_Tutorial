...
| **SQL & Relational DB 200+ Scenarios Master Guide** | [sql_scenarios_master_guide.md](scenarios/sql_scenarios_master_guide.md) | 200+ Production Scenarios: B-Tree Indexing Physics, MVCC, Gap Locks, SKIP LOCKED, Window Functions, Partitioning | 200+ Senior/Staff Scenarios in SQL, EXPLAIN ANALYZE & Tuning |
| **Enterprise Design Patterns 200+ Scenarios Master Guide** | [design_patterns_scenarios_master_guide.md](scenarios/design_patterns_scenarios_master_guide.md) | 200+ Production Scenarios: Double-Checked Locking Physics, Abstract Factory, Decorator vs Proxy, Saga, Outbox, CQRS | 200+ Senior/Staff Scenarios with Sample Code & Pitfalls |
| **Applied DSA 200+ Production Scenarios Master Guide** | [dsa_scenarios_master_guide.md](scenarios/dsa_scenarios_master_guide.md) | 200+ Production Scenarios: Disruptor Ring Buffer, Consistent Hashing VNodes, Bloom Filters, LSM vs B-Tree, Myers Diff | 200+ Senior/Staff Scenarios with Applied Production Systems |
...
| **Java Sockets to Spring Boot MVC Internals Master Guide** | [java_sockets_tomcat_spring_boot_mvc_internals_master_guide.md](spring-framework/java_sockets_tomcat_spring_boot_mvc_internals_master_guide.md) | OS Sockets, File Descriptors, Tomcat `NioEndpoint` (Acceptor/Poller/Worker), Coyote Request, `RequestFacade`, `ApplicationFilterChain`, `DispatcherServlet`, Interceptors, `@RequestBody` Jackson Stream Deserialization | Production Blueprints, War Room RCAs & Staff Scenarios |
| **Spring IoC, Security & JPA Internals Master Guide** | [spring_ioc_security_jpa_internals_master_guide.md](spring-framework/spring_ioc_security_jpa_internals_master_guide.md) | BeanDefinition Registry, 12-Step Lifecycle, Three-Level Cache, CGLIB/JDK Proxies, SecurityFilterChain, ProviderManager, PersistenceContext, Dirty Checking, ActionQueue | Production Blueprints, War Room RCAs & Staff Scenarios |
...
| **Deployment Strategies & Zero-Downtime Releases Master Guide** | [deployment_strategies_master_guide.md](devops-cicd-iac/deployment_strategies_master_guide.md) | Zero-Jargon Mental Models, Rolling, Blue-Green, Canary, Active-Passive DR, Feature Flags, Database Expand/Contract, K8s & Envoy | 5 Production Blueprints, 2 War Room RCAs & 50 Staff Interview Scenarios |
| **Deployment Strategies: 50 Production Scenarios Master Guide** | [deployment_strategies_50_scenarios_master_guide.md](scenarios/deployment_strategies_50_scenarios_master_guide.md) | RollingUpdate vs Canary, Istio Mirroring, Flagger Automated Canary Analysis, Active-Passive Split-Brain, Database Zero-Downtime Migration Traps | **50 Real-World Interview Scenarios** (Strict 4-Part Structure) |
...
| **DevOps & IaC Technical Terms Encyclopedia** | [devops_iac_technical_terms_master_guide.md](devops-cicd-iac/devops_iac_technical_terms_master_guide.md) | Zero-Jargon Definitions, Mental Models & Blueprints across Terraform, Ansible, Vault, Vagrant, Chef & Deployment Strategies | 6 Core Sections with 6-Part Deep Dives & Quick Reference Matrix |
...
| **Cloud Native & K8s Observability 200+ Scenarios Master Guide** | [cloud_kubernetes_observability_scenarios_master_guide.md](scenarios/cloud_kubernetes_observability_scenarios_master_guide.md) | Distroless Multi-Stage Builds, Zero-Downtime `preStop` Drains, HPA Autoscaling Formulas, PDB Eviction Budgets, OTel Batch Spans, Prometheus RED | **200+ Real-World Production Scenarios** (Strict 5-Part Structure) |
| **Java & Spring Boot Docker & Kubernetes Master Guide** | [java_spring_boot_docker_kubernetes_master_guide.md](cloud-infrastructure/java_spring_boot_docker_kubernetes_master_guide.md) | JVM cgroups v1/v2, MaxRAMPercentage, OOMKill 137, Layered JARs, Distroless/Temurin, Zero-Downtime preStop, Health Probes, HPA Sizing | Production Multi-Stage Dockerfiles, Zero-Downtime Helm/K8s Manifests & War Room RCAs |
...
| **Microservices & Distributed Systems 200+ Scenarios Master Guide** | [microservices_distributed_systems_scenarios_master_guide.md](scenarios/microservices_distributed_systems_scenarios_master_guide.md) | Distributed Sagas, 2PC vs Sagas, Outbox CDC, Eventual Consistency, Raft Quorum, Redisson Locks | **200+ Real-World Production Scenarios** (Strict 5-Part Structure) |
| **PostgreSQL Internals 200+ Scenarios Master Guide** | [postgresql_database_internals_scenarios_master_guide.md](scenarios/postgresql_database_internals_scenarios_master_guide.md) | MVCC xmin/xmax, WAL fsync, Autovacuum Freeze Outages, HOT Updates, PgBouncer Pool Sizing | **200+ Real-World Production Scenarios** (Strict 5-Part Structure) |
...
| **Enterprise Security & Auth Masterclass** | [security_auth_master_guide.md](security-identity/security_auth_master_guide.md) | Zero-Jargon Mental Models, AuthN vs AuthZ, OAuth 2.0/2.1/GNAP (OAuth 3), SAML 2.0, Active Directory, Kerberos, LDAP, JWT/JWS/JWE/JWKS, Coarse vs Fine AuthZ, RBAC/ARBAC97/ABAC/ReBAC/PBAC, XACML (PEP/PDP/PAP/PIP/PRP), Rules Engines (OPA, Cedar, Casbin, Cerbos, Drools), **60+ Essential Terms Glossary** (5-Part Deep Dives: Analogy, Mechanics, Traps, Complexity & War Rooms) | Flagship 10-Phase Security Encyclopedia & Complete Decision Matrices |
| **Enterprise Security, AuthN & AuthZ: 50 Production Scenarios Master Guide** | [security_auth_50_scenarios_master_guide.md](scenarios/security_auth_50_scenarios_master_guide.md) | OAuth 2.1 PKCE, Refresh Token Rotation, DPoP, JWE Encryption, alg:none & Key Confusion Exploits, SAML XSW & SLO, Kerberos Golden Ticket, ARBAC97, Zanzibar ReBAC, Cedar Automated Reasoning, BOLA/BFLA, SPIFFE mTLS | **50 Real-World Interview Scenarios** (Strict 4-Part Structure) |
...
| **Zero-Trust Security & Identity 200+ Scenarios Master Guide** | [oauth2_oidc_zero_trust_scenarios_master_guide.md](scenarios/oauth2_oidc_zero_trust_scenarios_master_guide.md) | OAuth 2.1 PKCE, Token Family Rotation, WebAuthn Passkeys, CSP Nonces, Timing Attacks, OPA ABAC | **200+ Real-World Production Scenarios** (Strict 5-Part Structure) |
...
| **API Protocols & Real-Time 200+ Scenarios Master Guide** | [api_protocols_realtime_scenarios_master_guide.md](scenarios/api_protocols_realtime_scenarios_master_guide.md) | REST Idempotency Keys, GraphQL DataLoader N+1, gRPC HTTP/2 Multiplexing, WebSockets, SSE | **200+ Real-World Production Scenarios** (Strict 5-Part Structure) |
| **REST API, OpenAPI 3.1 & Swagger Master Guide** | [rest_api_openapi_swagger_master_guide.md](frontend-web/rest_api_openapi_swagger_master_guide.md) | Flagship Guide: HTTP/1.1 vs HTTP/2/3, Weak/Strong ETags, RFC 7807 Problem Details, Idempotency-Key Deduplication, Keyset Paging, Lost Updates, Cache Stampedes, OpenAPI 3.1 & Swagger UI | 3 Production Outages / War Stories, 20 Anti-Patterns & 30-Point Audit Checklist |
| **Enterprise GraphQL Design, Generation & DataLoader Master Guide** | [graphql_design_query_generation_master_guide.md](frontend-web/graphql_design_query_generation_master_guide.md) | Flagship Guide: AST Execution, Relay Cursor Connections, Node Interface, In-Memory DataLoader Microtask Batching, Non-Null Bubbling, Cyclical Recursion DoS Defense | 3 Production Outages / War Stories, 20 Anti-Patterns & 30-Point Audit Checklist |
| **gRPC & Protobuf v3 Design & Generation Master Guide** | [grpc_protobuf_design_generation_master_guide.md](frontend-web/grpc_protobuf_design_generation_master_guide.md) | Flagship Guide: Varint/ZigZag Binary Physics, HTTP/2 Transport, 4 Streaming Patterns, Buf CLI v2 Workflow, Zero-Default Traps, L4 vs L7 Load Balancing | 3 Production Outages / War Stories, 20 Anti-Patterns & 30-Point Audit Checklist |
| **Real-Time Systems, WebSockets, SSE & Socket.IO Master Guide** | [realtime_websockets_sse_socketio_master_guide.md](frontend-web/realtime_websockets_sse_socketio_master_guide.md) | Flagship Guide: SSE `Last-Event-ID` Resume, RFC 6455 Binary Framing & Client Masking, Socket.IO / Engine.IO State Machine, Zombie Sockets, Thundering Herd Full Jitter, Redis Pub/Sub Backplane | 4 Production Outages / War Stories, 20 Anti-Patterns & 30-Point Audit Checklist |
| **Webhooks, Web Workers & WebRTC Master Guide** | [webhooks_webworkers_webrtc_master_guide.md](frontend-web/webhooks_webworkers_webrtc_master_guide.md) | Flagship Guide: HMAC-SHA256 Signatures, Fast-Ack Ingestion, Browser Multi-Threading, Structured Clone vs Transferable Memory, `SharedArrayBuffer` Atomics, SDP Offer/Answer, STUN/TURN/ICE, SFU Topologies | 4 Production Outages / War Stories, 20 Anti-Patterns, 40+ Terms Glossary & 30-Point Audit Checklist |
| **WebRTC & P2P Real-Time Communication Master Guide** | [webrtc_peer_to_peer_streaming_master_guide.md](frontend-web/webrtc_peer_to_peer_streaming_master_guide.md) | Flagship Guide: NAT Physics, STUN/TURN/ICE, SDP Offer/Answer Negotiation, Perfect Negotiation Pattern, `MediaStream` (SRTP) vs `RTCDataChannel`, Mesh vs SFU vs MCU Topologies, Codec Pipelines (Opus/VP9/AV1), `chrome://webrtc-internals` | 2 Production Outages / War Stories, 20 Anti-Patterns & 40+ Terms Glossary |
| **WebSocket (RFC 6455) & Socket.IO Master Guide** | [websocket_rfc6455_socketio_master_guide.md](frontend-web/websocket_rfc6455_socketio_master_guide.md) | Flagship Guide: RFC 6455 Binary Framing & 4-Byte Client XOR Masking Physics, HTTP 101 Handshake & SHA-1 Magic Key, Zombie Sockets & Dual Heartbeats, Backpressure, Redis Pub/Sub Distributed Backplane, Socket.IO State Machine & Namespaces | 2 Production Outages / War Stories, 20 Anti-Patterns, 40+ Terms Glossary & 30-Point Audit Checklist |
| **Server-Sent Events (SSE) Master Guide** | [server_sent_events_sse_master_guide.md](frontend-web/server_sent_events_sse_master_guide.md) | Flagship Guide: W3C `EventSource` Protocol, `text/event-stream` Wire Physics, `Last-Event-ID` Replay Resumption, HTTP/2 Stream Multiplexing, AI LLM Token Streaming (`[DONE]`, `AbortController`), NGINX Anti-Buffering (`X-Accel-Buffering: no`), Redis Distributed Backplane | 2 Production Outages / War Stories, 20 Anti-Patterns, 40+ Terms Glossary & 30-Point Audit Checklist |
| **WebTransport (QUIC & HTTP/3) Master Guide** | [webtransport_quic_http3_master_guide.md](frontend-web/webtransport_quic_http3_master_guide.md) | Flagship Guide: QUIC (RFC 9000) & HTTP/3 Extended CONNECT (RFC 9297), Bidirectional & Unidirectional Streams, Unreliable Datagrams, Head-of-Line Blocking Elimination, 0-RTT, Connection Migration, TLS 1.3 `serverCertificateHashes` | 2 Production Outages / War Stories, 20 Anti-Patterns, 40+ Terms Glossary & 30-Point Audit Checklist |
| **Network & Transport Protocols Master Guide** | [network_transport_protocols_tcp_udp_tls_http1_2_3_master_guide.md](frontend-web/network_transport_protocols_tcp_udp_tls_http1_2_3_master_guide.md) | Flagship Guide: L4/L7 Stack, UDP Datagrams, TCP (3-Way Handshake, Sliding Window, BBR Congestion), SSL/TLS (1.2 vs 1.3, mTLS, SNI/ALPN), HTTP/1.1 (Chunked, 6-Conn Limit) vs HTTP/2 (HPACK) vs HTTP/3 (QUIC/QPACK) | 2 Production Outages / War Stories, 20 Anti-Patterns, 40+ Terms Glossary & 30-Point Audit Checklist |
| **Omni-Protocol Real-Time Functional Platform** | [README.md](projects/omni-api-realtime-platform/README.md) | Full End-to-End Functional Codebase unifying REST (Swagger), GraphQL (DataLoader), gRPC (Protobuf), SSE, WebSockets, Socket.IO & Universal Event Envelopes | Complete Production Reference Implementation |
